...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['name-1'])) {$name = $_POST['to-buy-now-name'];}
    if (isset($_POST['phone-1'])) {$phone = $_POST['to-buy-now-tel'];}
    if (isset($_POST['phone-1'])) {$country = $_POST['to-buy-now-country'];}
    if (isset($_POST['phone-1'])) {$sum = $_POST['to-buy-full-cost'];}
